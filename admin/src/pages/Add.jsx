  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
        ...
        <div className='w-full'>
            ...
            <textarea type="text" onChange={(e)=>setDescription(e.target.value)} value={description}  placeholder='Type content here' className='w-full max-w-[500px] px-3 py-2' required />
        </div>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
                ...
                <input type="Number" onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' placeholder='price' />
            </div>
        </div>

        <div>
            <p className='mb-2'>Product Sizez</p>
